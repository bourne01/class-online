...
<style scoped>
	...
	.course-resource-form label{
		margin-bottom:5px;
		display:inline-block;
	}
	.course-resource-form .el-row{
		margin-bottom:15px;
	}	
	.course-resource-form .required{
		color:red;
		margin-right:2px;
	}
	.course-resource-dialog .el-select,
    .course-resource-dialog .el-input,
    .course-resource-dialog .el-range-editor,
	.course-resource-dialog .el-input-number,
	.course-resource-dialog .el-radio-group{
		width:100%;
	}
	.course-resource-dialog .confirm{
		height:38px;
		/* line-height:32px; */
		padding:0 40px;
...
<style>
    .add-course-resource .el-dialog__header{             /*设置弹框的头部*/
		background-color:#2185ff;
		height: 20px;
		color:#707079; 
		margin:0px;
	}
	.add-course-resource .el-dialog__header .el-dialog__title{       /*设置头部的标题样式*/ 
		color:white;
		float: left;
		line-height:10px;
		margin-left:20px;
	...
	.add-course-resource .el-dialog__headerbtn .el-dialog__close{      /*设置头部关闭的样式*/
		color:white;
		font-size:24px;
		margin-top:-30px;
	}
	.add-course-resource .el-dialog__body {                        /*设置弹框body内的内填充为0*/
		padding:15px;
		padding-bottom:10px;
		width:100%;
		box-sizing:border-box;
	}
	.add-course-resource .el-input__inner,
	.add-course-resource .el-textarea__inner{
