			...
			<div class="teacher-form">
				<el-row :gutter="20">					
					<el-col :span="12">
						...
						<div>
							<el-input v-model="teacher.resName"></el-input>
						</div>
					</el-col>
					<el-col :span="12">
						<label for=""><span class="required">*</span>格式</label>
						<div>
							<el-select v-model="teacher.resFormat">
				...
				<el-row :gutter="20">					
					<el-col :span="12">
						<label for=""><span class="required">*</span>类型</label>
						<div>
